...
namespace control_cmd_publisher {
    ...
    * pure adapter for simulators / Ackermann-driven vehicles (issue #288). Any CAN/DBW
    * transport is the sensing layer's concern and consumes the same ControlCommand.
    *
